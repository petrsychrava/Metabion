...
public class ClinicalAccessToken {
    ...
    protected ClinicalAccessToken() {
    }

    public ClinicalAccessToken(User user,
                               String tokenHash,
    ...
    public ClinicalAccessToken(User user,
        ...
        this(user, tokenHash, clientType, displayLabel, createdAt, expiresAt, resource, scopes, refreshFamilyId,
                false);
    }

    private ClinicalAccessToken(User user,
                                String tokenHash,
                                PatientAccessClientType clientType,
                                String displayLabel,
                                Instant createdAt,
    ...
    public Set<ClinicalAccessTokenScope> scopes() {
        return scopeGrants.stream()
                .map(ClinicalAccessTokenScopeGrant::getScope)
